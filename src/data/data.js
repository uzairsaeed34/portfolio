...
export const data = [
  {
    ...
    live: "",
    description:
      "The Colossal Store is an innovative e-commerce platform designed to revolutionize the online shopping experience for clothing, jewelry, shoes, and more. Built as a MERN stack project, the website integrates modern web technologies to provide a seamless and user-friendly interface for customers. The platform allows users to browse a wide range of products, with detailed descriptions, high-quality images, and easy-to-navigate categories that make finding the perfect item simple and enjoyable. The website's responsive design ensures that customers can shop effortlessly on any device, whether on a desktop, tablet, or smartphone. One of the standout features of the Colossal Store is its virtual try-on tool, which significantly enhances the shopping experience. This feature allows customers to virtually try on items before making a purchase, giving them a realistic idea of how the product will look on them. By using advanced image processing and 3D modeling techniques, the virtual try-on tool simulates the appearance of clothing, jewelry, and shoes on the user, helping them make more informed decisions. This innovative feature not only adds a layer of interactivity to the shopping process but also reduces the likelihood of returns, as customers can be more confident in their choices before completing a purchase.",
  },
  {
    id: 2,
    name: "Timmerman Car Rental- React JS",
    image: Proj6,
    github: "https://github.com/uzairsaeed34/timmerman-car-rental",
    live: "https://timmerman-car-rental.netlify.app",
    description:
      "I developed a dynamic and user-friendly car rental website with a complete frontend built using ReactJS. Leveraging powerful libraries like Reactstrap and Bootstrap for responsive and consistent design, I also integrated custom CSS to ensure a unique and polished look. The website boasts a variety of pages, each meticulously crafted to enhance the user experience, making navigation smooth and intuitive. With features like seamless booking processes, eye-catching visuals, and clear service information, this car rental platform is designed to provide users with an effortless and enjoyable experience, whether they are browsing options or finalizing their rental.",
  },
  {
    id: 3,
